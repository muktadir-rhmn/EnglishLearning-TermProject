...
<div id="container">
    ...
    <%
        ...
        Pair<String, String> searchResult = object.getLesson(request.getParameter("lesson"));
        if(searchResult!=null){
            String title = searchResult.getKey();
            String s = searchResult.getValue();
    %>
    <h1><b><%=title%></b></h1>
    <%=s%>
    <%
