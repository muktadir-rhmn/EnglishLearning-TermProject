    ...
    <div id="sidebar">
        ...
        <a href="ArticlePractice.jsp" class="list-group-item" style="${param.articlePractice}">Article Practice</a>
        <a href="PrepostionPractise.jsp" class="list-group-item" style="${param.prepositionPractice}">Preposition Practice</a>
